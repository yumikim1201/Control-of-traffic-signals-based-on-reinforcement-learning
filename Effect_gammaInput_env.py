...
class Traffic_Signal_Control():
    ...
    def step(self, action, gamma_input):
        ...
        """
        if action == 0:
            self.move_StraightOdd(gamma_input)

        elif action == 1:
            self.move_StraightEven(gamma_input)

        elif action == 2:
            self.move_StraightLeft0(gamma_input)

        elif action == 3:
            self.move_StraightLeft1(gamma_input)

        elif action == 4:
            self.move_StraightLeft2(gamma_input)

        elif action == 5:
            self.move_StraightLeft3(gamma_input)

        elif action == 6:
            self.move_LeftOdd(gamma_input)

        elif action == 7:
            self.move_LeftEven(gamma_input)
    ...
    def move_StraightOdd(self, gamma_input):
        gamma = [5, gamma_input, 5, gamma_input, 5, 5, 5, 5]
